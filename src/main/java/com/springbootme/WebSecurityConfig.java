...
//
//import com.springbootme.domain.RoleEnum;
//
//@Configuration
...
//
//		auth.inMemoryAuthentication().withUser("user").password("{noop}password").roles(String.valueOf(RoleEnum.USER))
//				.and().withUser("admin").password("{noop}password")
//				.roles(String.valueOf(RoleEnum.USER), String.valueOf(RoleEnum.ADMIN));
//
//	}
//
